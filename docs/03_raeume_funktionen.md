...
| Bad vorne | ja | 0 | 1 | ja |
| Abstellkammer (ehemals Dusche) | ja | 0 | 0 | nein |

Damit umfasst die Anlage **neun getrennte Räume**. Badezimmer, Bad vorne und Abstellkammer sind drei verschiedene Räume. Für die Abstellkammer ist ausschließlich Licht vorgesehen; sie erhält keine Rollladen-, Fenster- oder Heizungs-Gruppenadressen. Die vorhandene Home-Assistant-Altentität `climate.heizkorper_omaopa_dusche_1` ist ein Altbestand und keine Grundlage für neue KNX-Heizungsadressen.
