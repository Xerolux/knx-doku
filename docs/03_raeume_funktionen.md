...
Damit umfasst die Anlage **neun getrennte Räume**. Badezimmer und Abstellkammer sind nicht identisch. Für die Abstellkammer ist ausschließlich Licht vorgesehen; sie erhält keine Rollladen-, Fenster- oder Heizungs-Gruppenadressen. Die vorhandene Home-Assistant-Altentität `climate.heizkorper_omaopa_dusche_1` ist ein Altbestand und keine Grundlage für neue KNX-Heizungsadressen.
