...
5. Bei einem neuen Projekt `gruppenadressen-komplett.xml` importieren. Wurde die ältere Komplettdatei bereits importiert, nur `gruppenadressen-abstellkammer.xml` ergänzen.
